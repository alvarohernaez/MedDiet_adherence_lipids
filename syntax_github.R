...
xxx<-dat[,c("id","edad","sexo","escolar00","dmed_long_cat2",
            "tg00","f_tg00","hdl00","ldl_hdl00","f_col00","diabetes00",
            "hta00","tabaco00","obesidad00","af00","kcal00")]
xxx$sel<-1
...
long2<-createTable(compareGroups(dmed_long_cat2~.
                                 ...
                                 xxx, method=c("sexo"=3,"escolar00"=3,"diabetes00"=3,
                                               "f_col00"=3,"f_tg00"=3,
...
dir.create("D:/Artículos/Montse - MedDiet and lipid profile/Outputs/Repeated")
...
vars01<-c("ldl","hdl","ldl_hdl","nonhdl")
vars02<-c("ldl_basal","hdl_basal","ldl_hdl_basal","nonhdl_basal")
vars03<-c("f_col_basal","f_col_basal","f_col_basal","f_col_basal")
vars05<-c("ldl_hi160_inicio","hdl_lo_inicio","ldl_hdl_hi3_inicio","nonhdl_hi130_inicio")
  ...
  
{
  ...
  tab<-rbind(tab,cbind(class_g1,beta60_g1,lo60_g1,hi60_g1,beta65_g1,lo65_g1,hi65_g1,
                       beta70_g1,lo70_g1,hi70_g1,beta75_g1,lo75_g1,hi75_g1,beta80_g1,lo80_g1,hi80_g1))
  tab<-rbind(tab,cbind(class_g2,beta60_g2,lo60_g2,hi60_g2,beta65_g2,lo65_g2,hi65_g2,
                       beta70_g2,lo70_g2,hi70_g2,beta75_g2,lo75_g2,hi75_g2,beta80_g2,lo80_g2,hi80_g2))
  tab<-rbind(tab,cbind(class_g3,beta60_g3,lo60_g3,hi60_g3,beta65_g3,lo65_g3,hi65_g3,
                       beta70_g3,lo70_g3,hi70_g3,beta75_g3,lo75_g3,hi75_g3,beta80_g3,lo80_g3,hi80_g3))
  tab2<-rbind(tab2,cbind(class_g1,pval_group,pval_time_group,pval_nonlin_time,pval_int,coef60_g1,pval60_g1,coef65_g1,pval65_g1,
                         coef70_g1,pval70_g1,coef75_g1,pval75_g1,coef80_g1,pval80_g1))
  tab2<-rbind(tab2,cbind(class_g2,pval_group,pval_time_group,pval_nonlin_time,pval_int,coef60_g2,pval60_g2,coef65_g2,pval65_g2,
                         coef70_g2,pval70_g2,coef75_g2,pval75_g2,coef80_g2,pval80_g2))
  tab2<-rbind(tab2,cbind(class_g3,pval_group,pval_time_group,pval_nonlin_time,pval_int,coef60_g3,pval60_g3,coef65_g3,pval65_g3,
...
rownames(tab)<-c("LDL cholesterol (mg/dL)","LDL cholesterol (mg/dL)","LDL cholesterol (mg/dL)","LDL cholesterol (mg/dL)","LDL cholesterol (mg/dL)",
                 ...
                 "HDL cholesterol (mg/dL)","HDL cholesterol (mg/dL)","HDL cholesterol (mg/dL)","HDL cholesterol (mg/dL)","HDL cholesterol (mg/dL)",
                 "LDL-C/HDL-C ratio","LDL-C/HDL-C ratio","LDL-C/HDL-C ratio","LDL-C/HDL-C ratio","LDL-C/HDL-C ratio",
                 "LDL-C/HDL-C ratio","LDL-C/HDL-C ratio","LDL-C/HDL-C ratio","LDL-C/HDL-C ratio","LDL-C/HDL-C ratio",
...
rownames(tab2)<-c("LDL-C","LDL-C","LDL-C","LDL-C","LDL-C","LDL-C","LDL-C","LDL-C","LDL-C","LDL-C",
                  ...
                  "LDLc/HDLc","LDLc/HDLc","LDLc/HDLc","LDLc/HDLc","LDLc/HDLc","LDLc/HDLc","LDLc/HDLc","LDLc/HDLc","LDLc/HDLc","LDLc/HDLc",
  ...
  
{
  ...
  dat_long<-subset2(dat_long,"!is.na(dat_long[,vars02[i]])")
  xxx<-dat_long[,c("id",vars01[i],"dmed_long_cat4","age","sexo","escolar00","grup_int2",
                   "diabetes00","col_basal","hdl_basal","tg_basal","f_col_basal",vars03[i],"hta00","tabaco200",
                   "bmi00","af00","kcal00","prop_score01","prop_score02")]
  names(xxx)<-c("id","variable","group","seg","sexo","escolar","grup_int",
                "diabetes","col","hdl","tg","tt","tt2","hta","tabaco","imc","actfis","kcal","ps01","ps02")
  xxx$id2<-as.factor(xxx$id)
  xxx$seg<-as.numeric(xxx$seg)
  ...
  gam_predict<-expand.grid(group=factor(c(0,1,2,3)),
                           ...
                           id=unique(dat_long$id))
  xxx<-as.data.frame(unique(cbind(dat_long$id,dat_long$dmed_long_cat4,dat_long$sexo,dat_long$escolar00,dat_long$grup_int2,
                                  dat_long$diabetes00,dat_long$col_basal,dat_long$hdl_basal,dat_long$tg_basal,dat_long$f_col_basal,dat_long[,vars03[i]],
                                  dat_long$hta00,dat_long$tabaco200,dat_long$bmi00,dat_long$af00,dat_long$kcal00,
                                  dat_long$prop_score01,dat_long$prop_score02)))
  names(xxx)<-c("id","group_ok","sexo","escolar","grup_int",
                "diabetes","col","hdl","tg","tt","tt2","hta","tabaco","imc","actfis","kcal","ps01","ps02")
  ...
  xxx<-dat_long[,c("id",vars01[i],"dmed_long_cat2","age","sexo","escolar00","grup_int2",
                   ...
                   "bmi00","af00","kcal00","prop_score01","prop_score02",vars05[i])]
  names(xxx)<-c("id","variable","group","seg","sexo","escolar","grup_int",
                "diabetes","col","hdl","tg","tt","tt2","hta","tabaco","imc","actfis","kcal","ps01","ps02","strat")
  xxx$id2<-as.factor(xxx$id)
  xxx$seg<-as.numeric(xxx$seg)
  ...
  mod_gam01<-lme(variable~bs(seg,df=4)*group+tt2+tt+sexo+escolar+grup_int
                 +diabetes+col+hdl+tg+hta+tabaco+imc+actfis+kcal+ps01+ps02, 
                 random = ~1 | id2, 
                 correlation = corCAR1(form = ~seg | id2), 
                 control = lmeControl(opt="optim"), 
                 ...
                 method='REML',
                 na.action=na.exclude)
  mod_gam02<-lme(variable~bs(seg,df=4)*group*tt2+tt+sexo+escolar+grup_int
                 +diabetes+col+hdl+tg+hta+tabaco+imc+actfis+kcal+ps01+ps02, 
                 random = ~1 | id2, 
                 correlation = corCAR1(form = ~seg | id2), 
                 control = lmeControl(opt="optim"), 
  ...
  dat_long<-subset2(dat_long,"!is.na(dat_long[,vars02[i]]) & dat_long[,vars03[i]]==0")
  xxx<-dat_long[,c("id",vars01[i],"dmed_long_cat2","age","sexo","escolar00","grup_int2",
                   "diabetes00","col_basal","hdl_basal","tg_basal","f_col_basal","hta00","tabaco200",
                   "bmi00","af00","kcal00","prop_score01","prop_score02")]
  names(xxx)<-c("id","variable","group","seg","sexo","escolar","grup_int",
                "diabetes","col","hdl","tg","tt","hta","tabaco","imc","actfis","kcal","ps01","ps02")
  xxx$id2<-as.factor(xxx$id)
  ...
  gam_predict<-expand.grid(group=factor(c(0,1)),
                           ...
                           id=unique(dat_long$id))
  xxx<-as.data.frame(unique(cbind(dat_long$id,dat_long$dmed_long_cat2,dat_long$sexo,dat_long$escolar00,dat_long$grup_int2,
                                  dat_long$diabetes00,dat_long$col_basal,dat_long$hdl_basal,dat_long$tg_basal,dat_long$f_col_basal,
                                  dat_long$hta00,dat_long$tabaco200,dat_long$bmi00,dat_long$af00,dat_long$kcal00,
                                  dat_long$prop_score01,dat_long$prop_score02)))
  names(xxx)<-c("id","group_ok","sexo","escolar","grup_int",
                "diabetes","col","hdl","tg","tt","hta","tabaco","imc","actfis","kcal","ps01","ps02")
...
rownames(tab)<-c("triglycerides (mg/dL)","triglycerides (mg/dL)","triglycerides (mg/dL)","triglycerides (mg/dL)","triglycerides (mg/dL)",
                 "triglycerides (mg/dL)","triglycerides (mg/dL)","triglycerides (mg/dL)","triglycerides (mg/dL)","triglycerides (mg/dL)")
rownames(tab2)<-c("TG","TG","TG","TG","TG","TG","TG","TG","TG","TG")

tab<-rbind(tab3[1:20,],tab,tab3[31:40,],tab3[21:30,])
tab2<-rbind(tab4[1:20,],tab2,tab4[31:40,],tab4[21:30,])
...
vars01<-c(4,14,24,34,44)
vars02<-c(10,20,30,40,50)
vars03<-c("ldl","hdl","tg","nonhdl","ldl_hdl")
  ...
  
{
  ...
  tab<-NULL
  tab<-rbind(cbind(c(60,60,60,60,60,60,60),
...
vars01<-c("ldl","hdl","tg","nonhdl","ldl_hdl")
vars02<-c(2,2,8,2,4)
...
vars01<-c("ldl","hdl","tg","nonhdl","ldl_hdl")
vars02<-c(2,2.2,4,2,3.5)
vars03<-c("Statin users (baseline)","Statin users (baseline)","Fibrate users (baseline)","Statin users (baseline)","Statin users (baseline)")
vars04<-c("Statin non-users (baseline)","Statin non-users (baseline)","Fibrate non-users (baseline)","Statin non-users (baseline)","Statin non-users (baseline)")
vars05<-c("≥160 mg/dL (baseline)","Low HDL-C (baseline)","≥150 mg/dL (baseline)","≥130 mg/dL (baseline)","≥3 (baseline)")
vars06<-c("<160 mg/dL (baseline)","Non-low HDL-C (baseline)","<150 mg/dL (baseline)","<130 mg/dL (baseline)","<3 (baseline)")
...
dir.create("D:/Artículos/Montse - MedDiet and lipid profile/Outputs/Kaplan_Meier")
dir.create("D:/Artículos/Montse - MedDiet and lipid profile/Outputs/Survival")
dir.create("D:/Artículos/Montse - MedDiet and lipid profile/Outputs/Survival/backup")
dir.create("D:/Artículos/Montse - MedDiet and lipid profile/Outputs/Survival/backup/strat")
...
vars09<-c("f_tg00","f_tg00","f_col00","f_col00","f_col00","f_col00")
...
for(i in 1:(length(vars01)-4))
  
{ 
  orig_size<-dim(dat)[1]
  cond_baseline<-orig_size-length(which(dat[,vars03[i]]==0))
  labelok<-vars08[i]
  ...
  datx$dmed_long<-with(datx,ifelse(dmed_long<5,5,dmed_long))
  ...
  age_outofrange<-orig_size-cond_baseline-dim(datx)[1]
  dat2<-subset2(datx,"!is.na(datx$dmed_long)")
  samplesize<-dim(dat2)[1]
  ...
  mod01 <- coxph(
    Surv(entry_age, exit_age, xxx) ~
      ...
      as.factor(diabetes00) + col00 + hdl00 + tg00 + as.factor(f_col00) + as.factor(yyy) + as.factor(hta00) + 
  ...
  ps_formula <- dmed_long2 ~
    as.factor(grup_int) + as.factor(sexo) + as.factor(escolar00) +
    as.factor(diabetes00) + col00 + hdl00 + tg00 + as.factor(f_col00) +
  ...
  base_edad <- coxph(
    Surv(entry_age, exit_age, xxx) ~
      ...
      as.factor(grup_int) +
      as.factor(sexo) + as.factor(escolar00) +
      as.factor(diabetes00) + col00 + hdl00 + tg00 + as.factor(f_col00) + as.factor(yyy) +
  ...
  tab_ok<-rbind(tab_ok,cbind(median_time,orig_size,cond_baseline,age_outofrange,samplesize,
  ...
  tab<-rbind(tab,cbind(median_time,orig_size,cond_baseline,age_outofrange,samplesize,
